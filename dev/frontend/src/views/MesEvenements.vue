        ...
        <div class="mon-evenement-item">
          <div class="favoris-row">
            ...
            <div class="favoris-description">
              <p class="evenement-titre">{{evenementInv.titre}}</p>
              <p class="avec">
     ...
     <div
        ...
        <div class="mon-evenement-item">
          <div class="favoris-row">
            ...
            <div class="favoris-description">
              <p class="evenement-titre">{{evenementsHt.titre}}</p>
              <p class="avec">
          ...
          <button class="favoris-button" @click="redirect(evenementsHt.idEvenement)">Voir plus de detail</button>
        </div>
      </div>
    </div>
 </div>
